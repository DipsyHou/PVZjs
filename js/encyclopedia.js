...
(function(){
  const plants = [
    ...
    { id: 'corn_gatling', name: '玉米机枪', color: '#FFD700', cost: 275, hp: 200, cd: 7, desc: '发射玉米粒攻击，小概率发射黄油块。连续攻击时间越长，攻速越快' },
  ...
  const zombies = [
    ...
    { id: 'fisher', name: '渔夫僵尸', color: '#6b6b6b', hp: 200, speed: 20, desc: '使用鱼线将远处的植物拉向自己' },
    { id: 'gargantuar', name: '巨人僵尸', color: '#6b6b6b', hp: 4500, speed: 15, desc: '体型巨大，生命值极高，会砸扁阻拦的植物' },
    { id: 'priest', name: '牧师僵尸', color: '#9C27B0', hp: 200, speed: 20, desc: '为附近的受伤僵尸回复生命值' }
  ];
